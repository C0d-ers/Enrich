...
public class Minor_AMBank extends basePage {
    ...
    public void start() throws IOException, InterruptedException {
        ...
        String fullName = properties.getProperty("minorBankAccountName");
        ...
        String bankAccNo = properties.getProperty("minorBankAccountNumber");
