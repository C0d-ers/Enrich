...
public class data {
    ...
    public static Object [] [] Contacts1(){
        ...
        data [5][0] = "Joyce Byers";        data [5][1] = "605010150053";  //->5k
        data [6][0] = "Mike Wheeler";       data [6][1] = "605010150030";
        data [7][0] = "Dustin Henderson";   data [7][1] = "605010150034";  //->4k
        data [8][0] = "Nancy Wheeler";      data [8][1] = "605010150020";  // 10k
    ...
    public static Object [] [] leftContacts(){
        ...
        data [0][0] = "Will Byers";         data [0][1] = "605010150039";  //Loads of Saving Boxit
        data [4][0] = "Joyce Byers";        data [4][1] = "605010150053";
        data [5][0] = "Depa Billaba";       data [5][1] = "605010150027";
        data [6][0] = "Bail Organa";        data [6][1] = "605010150028";
        return data;
    }
